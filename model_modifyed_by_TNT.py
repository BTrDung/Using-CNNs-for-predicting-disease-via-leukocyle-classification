...
dataset = tf.keras.preprocessing.image_dataset_from_directory(data_dir, image_size=(150, 150), batch_size=30)
...
model.fit(dataset, batch_size=30, epochs=30, verbose=1)
