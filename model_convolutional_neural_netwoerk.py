...
model = tf.keras.models.Sequential([
    Convolution2D(filters=1, kernel_size=(3, 3), activation="relu", input_shape=(240, 320, 3)), 
...
img     = getImg('E:\SelfStudyTryHard\CS213\_0_187.jpeg')
rows    = img.shape[0] 
columns  = img.shape[1] 
img     = img.reshape(1, rows, columns, 3)
xTrain = img 
yTrain = np.array([[1]])
